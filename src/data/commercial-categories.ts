...
export const commercialCategoryPages: Record<CommercialCategoryPage['key'], CommercialCategoryPage> = {  windows: {
    ...
    heroCaption: 'A representative entry-door configuration for material, panel and glass planning.',
    heroFit: 'contain',
    ...
    heroCaption: 'A privacy door-glass example shown for design and configuration planning.',
    heroFit: 'contain',
